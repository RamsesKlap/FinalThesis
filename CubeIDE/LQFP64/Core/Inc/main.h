...
#define ADSR_LFO_CLK_Pin GPIO_PIN_10
#define ADSR_LFO_CLK_GPIO_Port GPIOC
#define ADSR_LFO_MISO_Pin GPIO_PIN_11
#define ADSR_LFO_MISO_GPIO_Port GPIOC
#define ADSR_LFO_MOSI_Pin GPIO_PIN_12
#define ADSR_LFO_MOSI_GPIO_Port GPIOC
